...
public class WaveLoadingView extends View {
    ...
    private int mOffsetX1 = 0,mOffsetX2 =0;
    ...
    private void handleStyleable(Context context, AttributeSet attrs){
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.WaveLoadView);
        try {
            mMode = ta.getInteger(R.styleable.WaveLoadView_wave_load_mode,COLOR_STYLE);
            ...
            mBallColor = ta.getColor(R.styleable.WaveLoadView_wave_load_color, Color.RED);
    ...
    private void initAnim(){
        ...
        mWaveHeightAnim = ValueAnimator.ofFloat();
